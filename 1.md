...
Collection of servers with static IP addresses and high upload speed with high internet speed is called data centre

## Sockets

A network socket is an endpoint that lets two programs send and receive data across a computer network. It is just a interface between process and the internet
